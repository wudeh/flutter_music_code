...
//     return _database.insert(_tableName, _illustToMap(illust),
...
//     return _database
//         .delete(_tableName, where: 'illust_id = ?', whereArgs: [illustId]);
//   }

//   Future<bool> exist(int illustId) async {
//     final result = await _database.rawQuery(
//         'SELECT 1 FROM local_browsing_history WHERE illust_id = ?', [illustId]);
//     return result.isNotEmpty;
//   }

//   Future<int> count() async {
//     final result = await _database
//         .rawQuery('SELECT COUNT(id) FROM local_browsing_history');
...
//     await _database
//         .execute('DELETE FROM sqlite_sequence WHERE name = ?', [_tableName]);
//   }
...
//       'meta_pages_json':
//           jsonEncode(instance.metaPages.map((e) => e.toJson()).toList()),
...
//       map['type'] as String,
//       ImageUrls.fromJson(
//           jsonDecode(map['image_urls_json']) as Map<String, dynamic>),
//       map['caption'] as String,
//       map['restrict'] as int,
//       User.fromJson(jsonDecode(map['user_json']) as Map<String, dynamic>),
//       (jsonDecode(map['tags_json']) as List<dynamic>)
//           .map((e) => Tag.fromJson(e as Map<String, dynamic>))
//           .toList(),
//       (jsonDecode(map['tools_json']) as List<dynamic>)
//           .map((e) => e as String)
//           .toList(),
...
//           jsonDecode(map['meta_single_page_json']) as Map<String, dynamic>),
