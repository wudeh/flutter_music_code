...
class DownloadFlacModel {
  DownloadFlacModel({
    this.data,
    this.code,
  });

  factory DownloadFlacModel.fromJson(Map<String, dynamic> jsonRes) =>
      DownloadFlacModel(
  ...
  DownloadFlacModel clone() => DownloadFlacModel.fromJson(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> jsonRes) => Data(
        ...
        level: asT<Object?>(jsonRes['level']),
        encodeType: asT<Object?>(jsonRes['encodeType']),
